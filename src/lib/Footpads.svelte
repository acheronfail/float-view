...
>
  <span style:color={adc1Enabled ? 'yellowgreen' : 'grey'}>ADC1: {data.adc1.toFixed(2)}V</span>
  <span style:color={adc2Enabled ? 'yellowgreen' : 'grey'}>ADC2: {data.adc2.toFixed(2)}V</span>
</div>
